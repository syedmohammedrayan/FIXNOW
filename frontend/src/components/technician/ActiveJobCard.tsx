      ...
      <div className="bg-gradient-to-br from-slate-800/80 via-slate-900/80 to-slate-800/80 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.6)] overflow-hidden flex flex-col relative z-10 w-full">
        ...
        <div className="p-8 lg:p-12 relative z-20">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 pb-10 border-b border-white/10">
            ...
            <div className="px-6 py-3 rounded-2xl bg-gradient-to-r from-emerald-500/20 to-emerald-600/20 border border-emerald-500/30 text-emerald-400 text-sm font-black uppercase tracking-[0.15em] shadow-[0_0_20px_rgba(16,185,129,0.15)] backdrop-blur-md flex items-center gap-3">
              <div className="size-2.5 rounded-full bg-emerald-400 animate-pulse shadow-[0_0_10px_rgba(52,211,153,0.8)]" />
              {jobStatus}
            </div>
          </div>
          ...
          {jobStatus !== "In Progress" ? (
            <>
              <div className="grid md:grid-cols-2 gap-6 mb-10">
                <div className="bg-slate-800/40 border border-white/10 p-6 lg:p-8 rounded-[2rem] hover:bg-slate-800/60 hover:border-white/20 transition-all duration-300 group flex flex-col justify-center relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-3 mb-5 relative z-10">
                    <div className="size-10 rounded-xl bg-cyan-500/20 text-cyan-400 flex items-center justify-center border border-cyan-500/20">
                  ...
                  <p className="text-white font-medium text-base lg:text-lg leading-relaxed relative z-10">
                ...
                <a 
                  ...
                  className="bg-slate-800/40 border border-white/10 p-6 lg:p-8 rounded-[2rem] hover:bg-indigo-500/10 hover:border-indigo-500/30 transition-all duration-300 active:scale-[0.98] group flex flex-col justify-center relative overflow-hidden cursor-pointer"
                >
                  <div className="absolute top-0 right-0 p-6 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity duration-500">
                    <Phone className="size-24 text-indigo-400" />
                  </div>
                  <div className="flex items-center gap-3 mb-5 relative z-10">
                    <div className="size-10 rounded-xl bg-indigo-500/20 text-indigo-400 flex items-center justify-center border border-indigo-500/20 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <p className="text-white font-bold text-lg lg:text-2xl tracking-[0.1em] relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                {["On the Way", "Arrived"].map((s) => (
                  <button
                    ...
                    className={cn(
                      "flex-1 py-5 rounded-[1.5rem] text-[13px] font-bold transition-all uppercase tracking-[0.15em] border flex items-center justify-center gap-3",
                      jobStatus === s
              ...
              {jobStatus === "Arrived" && (
                <motion.div
                  ...
                  className="mb-10 p-8 sm:p-12 bg-gradient-to-b from-slate-800/60 to-slate-900/60 border border-white/10 rounded-[2rem] shadow-[0_20px_40px_rgba(0,0,0,0.4)] relative overflow-hidden group/otp backdrop-blur-xl"
                >
                  <div className="absolute top-0 right-0 p-10 opacity-[0.02] group-hover/otp:opacity-[0.05] transition-opacity duration-1000 pointer-events-none">
                    <ShieldCheck className="size-48 text-white" />
                  </div>
                  
                  <div className="relative z-10 flex flex-col items-center text-center max-w-lg mx-auto">
                    <div className="inline-flex items-center justify-center gap-3 px-5 py-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full mb-6">
                      <span className="size-2 rounded-full bg-cyan-400 animate-pulse shadow-[0_0_10px_rgba(34,211,238,0.8)]" />
                      <span className="text-xs font-bold text-cyan-400 uppercase tracking-[0.2em]">Identity Verification</span>
                    </div>
                    <h3 className="text-2xl md:text-3xl font-black text-white mb-4 uppercase tracking-tight">Client Passcode</h3>
                    <p className="text-slate-400 text-sm mb-10 leading-relaxed max-w-sm">Enter the 4-digit security code provided by the client to initialize the mission protocol and commence work.</p>
                    ...
                    <button
                      ...
                      className="w-full py-5 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold uppercase tracking-[0.15em] text-sm rounded-[1.5rem] transition-all shadow-[0_15px_30px_rgba(34,211,238,0.3)] flex items-center justify-center gap-3 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {otpPhase === "verifying" ? (
                        <>
              ...
              {jobStatus !== "Arrived" && (
                <div className="mt-8 border-t border-white/10 pt-8">
                  <Link
                    ...
                    className="w-full py-6 bg-slate-800/40 border border-white/10 hover:bg-slate-700/60 hover:border-white/30 text-white font-bold rounded-[1.5rem] transition-all duration-300 shadow-lg flex items-center justify-center gap-3 active:scale-[0.98] text-sm uppercase tracking-[0.2em] group relative overflow-hidden"
                  >
