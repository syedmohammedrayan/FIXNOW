...
export function Navbar({ sidebarOpen, setSidebarOpen, activeTab, fetchData, setShowAddModal }: NavbarProps) {
  return (
    <header className="sticky top-0 z-30 px-6 min-h-[84px] flex justify-between items-center bg-white/10 backdrop-blur-2xl border-b border-white/40 shadow-2xl shadow-white/5">
